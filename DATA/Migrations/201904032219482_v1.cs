    ...
    public partial class v1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.Evenements", t => t.Evenement_IdEvent)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Ticket_IdTicket = c.Int(nullable: false),
                        Participant_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.Ticket_IdTicket, t.Participant_Id })
                .ForeignKey("dbo.Tickets", t => t.Ticket_IdTicket, cascadeDelete: true)
                .ForeignKey("dbo.Users", t => t.Participant_Id, cascadeDelete: true)
                .Index(t => t.Ticket_IdTicket)
                .Index(t => t.Participant_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Achat", "Participant_Id", "dbo.Users");
            DropForeignKey("dbo.Achat", "Ticket_IdTicket", "dbo.Tickets");
            DropForeignKey("dbo.Tickets", "Evenement_IdEvent", "dbo.Evenements");
            ...
            DropIndex("dbo.Achat", new[] { "Participant_Id" });
            DropIndex("dbo.Achat", new[] { "Ticket_IdTicket" });
            ...
            DropIndex("dbo.Tickets", new[] { "Evenement_IdEvent" });
